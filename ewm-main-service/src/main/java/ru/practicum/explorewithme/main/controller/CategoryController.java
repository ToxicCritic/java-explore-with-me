...
public class CategoryController {
    ...
    public CategoryDto add(@RequestBody @Valid CategoryDto dto) { return service.add(dto); }

    @PatchMapping("/admin/categories/{id}")
    public CategoryDto edit(@PathVariable Long id, @RequestBody @Valid CategoryDto dto) {
